...
export function Integrantes() {
  const integrantes = [
    { src: saul, nome: 'Saul Gabriel', desc: '@saul_gabriel7', cor:'rgb(3, 147, 100, 0.7)' },
    { src: taina, nome: 'Tainá Dos Santos', desc: '@_taina.santoos', cor:'rgb(0, 0, 0, 0.7)'},
    { src: esther, nome: 'Esther Santos', desc: '@estherrr.q', cor:'rgb(122, 103, 53, 0.7)'},
    { src: davi, nome: 'Davi Da Hora', desc: '@littlee_davis', cor:'rgb(112, 194, 199, 0.7)' },
  ];
